...
import telegram
from PrincyRobot import TIGERS, WOLVES, dispatcher
from PrincyRobot.modules.disable import DisableAbleCommandHandler
from PrincyRobot.modules.helper_funcs.chat_status import (bot_admin,
                                                           can_restrict,
                                                           is_user_admin,
                                                           user_admin,
                                                           user_admin_no_reply)
...
from PrincyRobot.modules.helper_funcs.string_handling import split_quotes
from PrincyRobot.modules.log_channel import loggable
from PrincyRobot.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Princy's sticker
        keyboard = None
