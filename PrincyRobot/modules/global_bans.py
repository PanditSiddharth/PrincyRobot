...
from PrincyRobot.modules.sql.users_sql import get_all_chats
    ...
    for chat in chats:
        ...
        try:
            ...
            if excp.message in UNGBAN_ERRORS:
                ...
                if EVENT_LOGS:
                    bot.send_message(EVENT_LOGS, f"Could not un-gban due to: {excp.message}",
                                     parse_mode=ParseMode.HTML)
                else:
...
/antispam
Note: You can appeal gbans or ask gbans at @princysupport
