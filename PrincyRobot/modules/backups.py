...
import PrincyRobot.modules.sql.notes_sql as sql
from PrincyRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from PrincyRobot.__main__ import DATA_IMPORT
from PrincyRobot.modules.helper_funcs.chat_status import user_admin
from PrincyRobot.modules.helper_funcs.alternate import typing_action

# from PrincyRobot.modules.rules import get_rules
import PrincyRobot.modules.sql.rules_sql as rulessql

# from PrincyRobot.modules.sql import warns_sql as warnssql
import PrincyRobot.modules.sql.blacklist_sql as blacklistsql
from PrincyRobot.modules.sql import disable_sql as disabledsql

# from PrincyRobot.modules.sql import cust_filters_sql as filtersql
# import PrincyRobot.modules.sql.welcome_sql as welcsql
import PrincyRobot.modules.sql.locks_sql as locksql
from PrincyRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("PrincyRobot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("PrincyRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `PrincyRobot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("PrincyRobot{}.backup".format(chat_id))  # Cleaning file
